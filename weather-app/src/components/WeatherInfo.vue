  ...
  >
    ...
    <div class="flex items-center justify-between gap-6 mb-20">
      ...
      <div class="text-center flex-1">
        ...
        <p class="text-xl font-bold">{{ current.precip_mm }} mm</p>
        <p>precipitation</p>
      </div>
    </div>
    <div class="flex items-center justify-between gap-6 mb-10">
      ...
      <div class="text-center flex-1">
        ...
        <p class="text-xl font-bold">{{ current.wind_dir }}</p>
        <p>direction</p>
      </div>
      <!-- Feels like -->
      <div class="text-center flex-1">
        <i class="fa-solid fa-temperature-half mb text-2xl"></i>
        <p class="text-xl font-bold">{{ Math.round(current.feelslike_c) }}</p>
        <p>Feels</p>
      </div>
      <!-- UV -->
      <div class="text-center flex-1">
        <i class="fa-solid fa-sun mb text-2xl"></i>
        <p class="text-xl font-bold">{{ current.uv }}</p>
        <p>UV index</p>
      </div>
    </div>
    <!-- Last update and delete -->
    <div class="flex justify-between items-center">
      <h3 class="text-slate-900/50">last update {{ current.last_updated }}</h3>
      <button @click="emitRemove" class="p-1">
